...
async def get_tools(current_user: User = Depends(get_current_user)):
    tools_list = [
        ...
        {
            "name": "CalMind",
            "description": "Manage your calendar and mind.",
            "path": "/calmind",
            "required_role": "user",
        },
        {
            "name": "MonitorIQ",
            "description": "Intelligent monitoring and alerts.",
            "path": "/monitoriq",
            "required_role": "user",
        },
        {
            "name": "RegressionInsight",
            "description": "Gain insights into your test regressions.",
        ...
        {
            "name": "XrayQC",
            "description": "Quality control for X-ray images.",
            "path": "/xrayqc",
            "required_role": "user",
        },
        {
